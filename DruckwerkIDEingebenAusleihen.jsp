...
<html>
    <head>
        ...
        <title>Taubenschlag AG - Client-Server - Druckwerk ID Eingeben Ausleihen</title>
    ...
    <body>
        ...
        <script>
        function nextgui() {
            window.open("DruckwerkAusleihen.jsp","DruckwerkAusleihen", "popup=1,width=500,height=500");             
            window.open('', '_self', ''); 
            window.close();
        } 
        </script>   
