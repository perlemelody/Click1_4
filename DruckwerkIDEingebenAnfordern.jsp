...
<html>
    <head>
        ...
        <title>Taubenschlag AG - Client-Server - Druckwerk ID Eingeben Anfordern</title>
    ...
    <body>
        ...
        <script>
        function nextgui() {
            window.open("DruckwerkAnfordern.jsp","DruckwerkAnfordern", "popup=1,width=500,height=500");             
            window.open('', '_self', ''); 
            window.close();
        } 
        </script>   
